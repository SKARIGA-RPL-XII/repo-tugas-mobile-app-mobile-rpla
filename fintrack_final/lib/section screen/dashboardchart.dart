...
class _Sect3State extends State<Sect3> {
  ...
  Widget _header(BuildContext context){
   ...
   Widget _cardprofil(BuildContext context){
    return Positioned(
      ...
      height: scaleHeight(135, context),
      child: Container(
        ...
        children: [
          Row(
            children: [
              ...
              Icon(Icons.content_copy, size: scaleFontSize(16, context), color: Colors.grey[600]),
               SizedBox(width: scaleWidth(2, context)),
                  Text(
                    'X4FY70E',
                    style: GoogleFonts.montserrat(
              ...
              Row(
                children: [
                  Icon(Icons.person, size: scaleFontSize(16, context), color: Colors.grey[600]),
                  SizedBox(width: scaleWidth(2, context)),
                  Text(
                    '5',
                    style: GoogleFonts.montserrat(
              ...
              SizedBox(width: scaleWidth(8, context)),
              Icon(Icons.delete_outline, size: scaleFontSize(16, context), color: Colors.red[400]),
            ],
          ),
        ...
        Container(
          ...
          child: Center(
            child: Row(
              ...
              children: [
                Padding(
                  padding: EdgeInsets.only(left: scaleWidth(16, context)),
                  child: Text(
                    'Management User',
                    style: GoogleFonts.montserrat(
                      fontSize: scaleFontSize(12, context),
                ...
                Padding(
                  padding: EdgeInsets.only(right: scaleWidth(16, context)),
                  child: Icon(Icons.arrow_forward_ios, size: scaleFontSize(16, context), color: Colors.white),
                ),
              ],
            ),
          ),
  ...
  Widget _cardtransaksi(BuildContext context){
    return Positioned(
      top: scaleHeight(790, context),
      width: scaleWidth(381, context),
      height: scaleHeight(340, context),
      left: scaleWidth(16, context),
      child: Container(
        decoration: BoxDecoration(
          color: Color(0xFFE6E9EF),
